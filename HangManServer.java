...
public class HangManServer {
	...
	HangManServer( Socket s ) throws IOException{
		 socket = s;
	...
	public static void main(String argus[]) throws IOException {
		...
		while(true) {
			...
			HangManServer aGame = new HangManServer(server);
			try {
				aGame.game();
			} catch (Exception e) {
				System.out.println("Client quit without finishing game");
			}
			System.out.println("one game over");
		}
